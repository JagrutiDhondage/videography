...
<html lang="en">
<head>
  <title>News <?php echo " :".$_SESSION["username"]; ?></title>
  <meta charset="utf-8">
...
<div class="container-fluid">
  <div class="row content">
    ...
    <div class="col-sm-3 sidenav">
      ...
      <ul class="nav nav-pills nav-stacked">
        ...
        <li class="active"><a href="logNews.php"> <span class="glyphicon glyphicon-globe"></span> News</a></li>
      </ul><br>
 ...
 <!-----------navigation end------>
    ...
    <div class="col-sm-9">
      ...
      <h4><small>NEWS UPLOADS</small></h4>
      <hr>
		<?php 
	...
	if($connect)
	{
		...
		$cursor = $col->find((array("category" => 'news'))); //echo $cursor->getFilename();
		$cursor->sort(["date"=>-1]);
		//echo $count; 
