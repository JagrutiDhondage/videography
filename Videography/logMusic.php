...
<html lang="en">
<head>
  <title>Music <?php echo " :".$_SESSION["username"]; ?></title>
  <meta charset="utf-8">
...
<div class="container-fluid">
  <div class="row content">
    ...
    <div class="col-sm-3 sidenav">
      ...
      <ul class="nav nav-pills nav-stacked">
        ...
        <li class="active"><a href="logMusic.php"> <span class="glyphicon glyphicon-music"></span> Music</a></li>
 ...
 <!-----------navigation end------>
    ...
    <div class="col-sm-9">
      ...
      <h4><small>MUSIC UPLOADS</small></h4>
      <hr>
		<?php 
	...
	if($connect)
	{
		...
		$cursor = $col->find((array("category" => 'music'))); 
		$cursor->sort(["date"=>-1]);
