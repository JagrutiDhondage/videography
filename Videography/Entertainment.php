						...
						<div class="container">
						  ...
						  <form class="form-horizontal"  method = "post" enctype="multipart/form-data">
							...
							<div class="form-group">
								<label class="control-label col-xs-1" for="email">Email-ID:</label>
								<div class="col-xs-4">
								<input type="email" name = "new" class="form-control" id="name" placeholder="Enter Email-ID" pattern="([a-z0-9_\.-]+)@([\da-z\.-]+)\.([a-z\.]{2,6})" required>
								</div>
							</div>
							<div class="form-group">
									<label class="control-label col-xs-1" for="comment">Password:</label>
									<div class="col-xs-4">
										<input type="password" name = "pw" class="form-control" id="name" placeholder="Enter Password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters." required>
									</div>
							</div>
...
<div class="container-fluid">
     ...
     <h4> <span class="glyphicon glyphicon-menu-hamburger"></span> Category</h4>
      <ul class="nav nav-pills nav-stacked">
        ...
        <li><a href="music.php"> <span class="glyphicon glyphicon-music"></span> Music</a></li>
		 <li class="active"><a href="Entertainment.php"> <span class="glyphicon glyphicon-film"></span> Entertainment</a></li>
 ...
 <!-----------navigation end------>
    ...
    <div class="col-sm-9">
      ...
      <h4><small>ENTERTAINMENT UPLOADS</small></h4>
      <hr>
		<?php 
	...
	if($connect)
	{
		...
		$cursor = $col->find((array("category" => 'Entertainment'))); 
		$count = $cursor->count();
		$cursor->sort(["date"=>-1]);
