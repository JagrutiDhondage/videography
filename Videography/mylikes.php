...
?>
      ...
      <ul class="nav nav-pills nav-stacked">
        ...
        <li ><a href="viewProfile.php"><span class="glyphicon glyphicon-facetime-video"></span>  My Videos</a></li>
		  <li class="active" ><a href="mylikes.php"><span class="glyphicon glyphicon-play-circle"></span>  Liked Videos</a></li>
...
<?php 
	...
	$connect = new MongoClient(); 
		...
		foreach ($user['likedVideo'] as $video)
		{
