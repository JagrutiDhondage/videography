...
<html lang="en">
<head>
  <title>Entertainment <?php echo " :".$_SESSION["username"]; ?></title>
  <meta charset="utf-8">
	 ...
	 <h4> <span class="glyphicon glyphicon-menu-hamburger"></span> Category</h4>
      <ul class="nav nav-pills nav-stacked">
        ...
        <li><a href="logMusic.php"> <span class="glyphicon glyphicon-music"></span> Music</a></li>
		 <li class="active"><a href="logEntertainment.php"> <span class="glyphicon glyphicon-film"></span> Entertainment</a></li>
